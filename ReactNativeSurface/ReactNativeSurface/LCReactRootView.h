...
@protocol LCReactRootViewDelegate
 ...
 */
@interface LCReactRootView : UIView
...
@property (nonatomic, weak) id<LCReactRootViewDelegate> lc_delegate;
...
@interface LCReactRootView (Deprecated)
